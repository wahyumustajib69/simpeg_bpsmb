	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h2 class="page-title"><i class="fa fa-list"></i> GOLONGAN PEGAWAI</h2>

				<!-- Zero Configuration Table -->
				<div class="panel panel-primary">
					<div class="panel-heading">SEMUA DATA GOLONGAN</div>
					<div class="panel-body table-responsive">
						...
						<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							...
							<tbody>
								<?php
								$no=1;
								$sql = mysqli_query($konek,"SELECT*FROM golongan");
								...
								<tr>
									...
									<td>
										<a id="<?php echo $row['id_gol'] ?>" class="btn btn-xs btn-primary modal_edit"><i class="fa fa-edit"></i> EDIT</a>
										<a onclick="konfirmasi('golongan_del.php?id=<?php echo $row['id_gol'] ?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> HAPUS</a>
									</td>
								</tr>
								<?php } ?> 
							</tbody>
				...
				<!-- Modal -->
				<form method="post" action="golongan_add.php" enctype="multipart/form-data">
									...
									<div class="col-md-12">
										<div class="form-group">
											<div class="row">
												...
												<div class="col-md-9">
													<input type="text" name="pnkt" required="required" class="form-control input-sm">
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-md-9">
													<input type="text" name="jbtn" required="required" class="form-control input-sm">
												</div>
											</div>
										</div>								

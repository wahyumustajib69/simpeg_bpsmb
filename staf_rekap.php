...
<div style="font-family: times;">
	...
	<div class="text-center"><h4 class="text-bold"><u>REKAP SPPD STAF BALAI TAHUN <?php echo date("Y"); ?></u></h4></div>
	...
	<table class="table" border="1">
		...
		<tbody>
			<?php
			$no=1;
			$sql =mysqli_query($konek,"SELECT*FROM sppd AS a JOIN pegawai AS b ON a.nip=b.nip JOIN golongan AS c ON b.gol=c.id_gol JOIN jabatan AS d ON b.jabatan=d.id_jbtn WHERE a.ket='ST' ORDER BY a.tgl_surat DESC");

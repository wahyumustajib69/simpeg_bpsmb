	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h2 class="page-title"><i class="fa fa-users"></i> SPPD STAF</h2>
					...
					<div class="panel-body table-responsive">
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-2" style="margin-bottom: 8px;">
										<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#ModalStaf">
						...
						<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							...
							<tbody>
								<?php
								$no=1;
								$sql = mysqli_query($konek,"SELECT*FROM sppd AS A JOIN pegawai AS b ON a.nip=b.nip  WHERE ket='ST' ORDER BY no_surat DESC");
								...
								<tr>
									...
									<td>
										...
										<a onclick="konfirmasi('staf_del.php?id=<?php echo $row['id_surat'] ?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
										<a href="staf_cetak?ref=<?php echo $row['id_surat'] ?>" target="_blank" class="btn btn-xs btn-success"><i class="fa fa-print"></i> </a>
									</td>
								</tr>
								<?php } ?> 
							</tbody>
				...
				<!-- Modal -->
				<form method="post" action="staf_add.php" enctype="multipart/form-data">
				<div class="modal fade" id="ModalStaf" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header bg-primary">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times-circle"></i></span></button>
								<h4 class="modal-title" id="myModalLabel">TAMBAH SPPD STAF</h4>
							</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-md-9">
													<select name="pgw" required="required" class="form-control input-sm nmpgw" style="width: 100%;">
				...
				<div class="modal fade" id="stafEdit"></div>
